...
R package for import datasets of Coronavirus disease 2019 in South Korea from [Coronavirus-Dataset repository](https://github.com/jihoo-kim/Coronavirus-Dataset).
...
library(ggplot2) %>% 
ggplot(data = time, aes(x = date, y = acc_confirmed)) + 
